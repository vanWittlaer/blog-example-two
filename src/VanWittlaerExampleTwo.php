...
namespace VanWittlaer\ExampleTwo;
...
class VanWittlaerExampleTwo extends Plugin
{
    ...
    private function createCustomFields(Context $context): void
    {
        ...
        $customFieldSetRepository->create([
            [
                ...
                'name' => 'vanwittlaer_address_set',
                'global' => true, // set this to true to prevent accidental editing in admin
                'config' => [
                    'label' => [
                        'en-GB' => 'Additional Address Fields',
                        'de-DE' => 'Zusätzliche Adressfelder',
                    ],
                ],
                'customFields' => [
                    [
                        'name' => 'vanwittlaer_what_three_words',
